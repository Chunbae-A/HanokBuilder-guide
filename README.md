...
| ---: | --- | --- |
| 1 | 개요 | 기능 카드, 스펙, 활용 대상 |
| 2 | 시뮬레이션 영상 | HanokBuilder 주요 기능 시뮬레이션 영상 |
| 3 | 화면 구성 | 7개 영역 어노테이션 설명 |
| 4 | 시작 흐름 | 처음 시작하는 5단계 절차 |
| 5 | 배경 프리셋 | 맑은날 / 저녁노을 / 밤 / 자연 4가지 |
...
| 프리셋 | 분위기 | 추천 활용 |
| --- | --- | --- |
| ☀️ 맑은날 (기본) | 청명한 낮 하늘 — 에셋 색감과 디테일이 가장 잘 보임 | 일반 배치 작업, 전체 구성 확인 |
| 🌇 저녁노을 | 붉은 황혼 빛 — 따뜻하고 드라마틱한 분위기 | 감성적 씬 연출, 캡처 구도 연습 |
| 🌙 밤 | 어두운 밤하늘과 별빛 — 고요하고 신비로운 야간 환경 | 야간 씬 레퍼런스, 조명 강조 장면 |
| 🌿 자연 | 녹음 짙은 자연 환경 — 생동감 있는 풍경 연출 | 자연물·수목 배치, 정원·경관 구성 |
