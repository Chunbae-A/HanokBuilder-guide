...
HanokBuilder는 Unity 6 기반으로 개발된 한국 전통 건축 공간 3D 제작 도구입니다. 한국문화정보원이 공개한 문화공공데이터를 원천으로 완성형 한옥 건물, 건축 부품, 자연물, 소품, 디지털 휴먼 에셋을 제공합니다.
...
| ---: | --- | --- |
| 1 | 개요 | 기능 카드, 스펙, 활용 대상 |
| 2 | 화면 구성 | 7개 영역 어노테이션 설명 |
| 3 | 시작 흐름 | 처음 시작하는 5단계 절차 |
| 4 | 배경 프리셋 | 한옥 마당 / 저녁노을 / 밤 / 자연 4가지 |
| 5 | 에셋 라이브러리 | 카테고리 구조, 검색 방법 |
| 6 | 카메라 조작 | 마우스, 키보드, Numpad 시점 전환 |
| 7 | 편집 도구 | 이동 / 회전 / 크기 / 삭제 + 단축키 |
| 8 | 부재 정보 패널 | 위치 · 회전 · 크기 수치 조정 |
| 9 | AI 기능 | 에셋 추천 / AI 자동 레이아웃 / 자연어 씬 편집 |
| 10 | 문화재 해설 | 건물 클릭 시 Claude 해설 생성 |
| 11 | 캡처 | PNG 저장 방법 및 파일 형식 |
| 12 | 단축키 전체 | 편집 / 카메라 / 뷰 전환 탭 |
| 13 | 문제 해결 | 자주 묻는 질문 10가지 |
| 14 | 문화데이터 출처 | 한국문화정보원 공개 데이터 |
...
| 레포 | 설명 |
| --- | --- |
| [Unity-3D_Korean_Traditional_Architecture](https://github.com/Chunbae-A/Unity-3D_Korean_Traditional_Architecture) | HanokBuilder Unity 앱 소스 (C# · URP) |
